...
window._config = {
    ...
    api: {
        invokeUrl: 'https://rh6u1asb8d.execute-api.us-east-1.amazonaws.com/prod' // e.g. https://rc7nyt4tql.execute-api.us-west-2.amazonaws.com/prod',
    }
};

```

validamos que se despliegue en 
